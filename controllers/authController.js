...
const createSendToken = (user, statusCode, res) => {
  ...
  // set the secure option true for prod environment
...
// verify the jwt and allow verified users to view the protected route
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // Grant access to the protected route and Create req.user
  req.user = currentUser;
  res.locals.user = currentUser;
  next();
});

// This middleware is to check if the user is logged in
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  // 1) Get user based on posted emailss
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 3) Update changedPasswordAt property for the current users by a middleware
